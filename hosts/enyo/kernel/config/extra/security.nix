  ...
  boot.kernelPatches = [
    {
      ...
      extraStructuredConfig = mapAttrs (_: mkForce) {
        ...
        ARCH_MMAP_RND_BITS = "32"; #https://cateee.net/lkddb/web-lkddb/ARCH_MMAP_RND_BITS.html
        ...
        ARCH_MMAP_RND_COMPAT_BITS = "16"; # same as above. COMPAT_BITS_MIN=8,COMPAT_BITS_MAX=16,COMPAT_BITS=8, when in xanmod github it's 8,16,16 and cachyos 8,16,16.
        ...
        DEFAULT_MMAP_MIN_ADDR = "65536"; # xanmod and cachyos-bore defaults. CachyOS hardened also set to 65536.
